<script context="module">
	...
	import { heroBanner, previewMode, groupBy, createCalendarLink, formatDayOfWeek, formatDateLong } from '$lib/globals.mjs';
...
<div class="max-w-5xl px-5 mx-auto space-y-20 pb-24">
	...
	<div class="space-y-10">
		...
		<div class="grid md:grid-cols-2 gap-5 gap-y-20">
			<!-- left col -->
			<div class="space-y-10">
        <h1 class="notch-left text-xl">Events this week</h1>
